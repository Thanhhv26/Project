...
public class CategoryController {
	...
	@RequestMapping(value = PageConst.CATEGORY_CREATE, method = { RequestMethod.POST })
	public @ResponseBody Object create(@RequestBody Object obj) throws Exception {
		
		return null;
	}
	
	@RequestMapping(value = PageConst.CATEGORY_UPDATE, method = { RequestMethod.POST })
	public @ResponseBody Object update(@RequestBody Object obj) throws Exception {
		
		return null;
	}
	
	@RequestMapping(value = PageConst.CATEGORY_DELETE, method = { RequestMethod.POST })
	public @ResponseBody Object delete(@RequestBody Object obj) throws Exception {
		
		return null;
	}
	
	@RequestMapping(value = PageConst.CATEGORY_DETAIL, method = { RequestMethod.POST })
	public @ResponseBody Object detail(@RequestBody Object obj) throws Exception {
		
		return null;
	}
	
	@RequestMapping(value = PageConst.CATEGORY_SEARCH, method = { RequestMethod.POST })
	public @ResponseBody List<Object> search(@RequestBody Object obj) throws Exception {		
		return null;
	}
	
	@RequestMapping(value = PageConst.CATEGORY_SEARCH_ALL, method = { RequestMethod.POST })
